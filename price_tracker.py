"""
Allegro Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Allegro.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/allegro
"""
...
# Set your Web Scraper ID after building your Allegro scraper:
# https://brightdata.jp/products/web-scraper/allegro
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Allegro scraper at: https://brightdata.jp/products/web-scraper/allegro\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Allegro product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Allegro products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Allegro category page.

    Example:
        results = discover_by_category("https://allegro.pl/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.allegro.pl/product/sample-item-123456",
        # Add more Allegro product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "allegro_prices.json"
    ...
    # cat_results = discover_by_category("https://allegro.pl/category/sample", limit=50)
